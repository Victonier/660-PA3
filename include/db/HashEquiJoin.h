...
namespace db {
    ...
    class HashEquiJoin : public Operator {
        ...
        JoinPredicate p = JoinPredicate(0, Predicate::Op::GREATER_THAN_OR_EQ, 0);
        DbIterator *leftchild, *rightchild;
        std::map <Field*, std::vector<Tuple>*> *TupleMap=new std::map<Field*, std::vector<Tuple>*>();
        bool loadMap();
    protected:
        /**
